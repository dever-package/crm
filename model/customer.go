...
type Customer struct {
	...
	Source    string    `dorm:"type:varchar(32);not null;default:'default';comment:来源"`
	Level     string    `dorm:"type:varchar(32);not null;default:'default';comment:客户等级"`
...
type CustomerIndex struct {
	...
	SourceLevel struct{} `index:"source,level,id"`
}
