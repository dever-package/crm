...
type Attachment struct {
	...
	UploadFileID    uint64    `dorm:"type:bigint;not null;default:0;comment:上传文件"`
	Usage           string    `dorm:"type:varchar(32);not null;default:'';comment:附件用途"`
...
type AttachmentIndex struct {
	...
	ScheduleUsage struct{} `index:"schedule_event_id,usage,created_at,id"`
}
